    ...
    <ThemeProvider theme={theme}>
      <Box >
        ...
        <Box className="aboutContent" sx={{display: "flex", justifyContent: "space-between"}}>
          <Box>
            ...
            <Typography className="aboutTextPadding">Full Stack Web Development</Typography>
          </Box>
      ...
      <Box sx={{paddingTop: "20px"}}>
        <Box className="underline">
          ...
          : 
          <Typography variant="h6" className="aboutHeaders">BCIT</Typography>
          }
        </Box>
        <Box className="aboutContent"sx={{display: "flex", justifyContent: "space-between"}}>
          <Box>
            <Typography className="aboutTextPadding">Bachelor's Degree</Typography>
            <Typography className="aboutTextPadding">Mechanical Engineering</Typography>
          </Box>
