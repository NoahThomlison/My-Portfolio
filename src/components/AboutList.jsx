        ...
        <Paper sx={{display: "flex", justifyContent: "center", alignItems: "center", padding: ".75em"}}>
          ...
          <Box className="profileText">
            <Box className="buttons">
              <Button className="aboutButton" variant={active === "About" ? 'contained': "outlined"} onClick={(()=> handleClick("About"))}>Stuff about me</Button>
              <Button className="aboutButton" variant={active === "TechStack" ? 'contained': "outlined"} onClick={(()=> handleClick("TechStack"))}>Tech I use</Button>
              <Button className="aboutButton" variant={active === "WorkHistory" ? 'contained': "outlined"} onClick={(()=> handleClick("WorkHistory"))}>Where I worked</Button>
              <Button className="aboutButton" variant={active === "Education" ? 'contained': "outlined"} onClick={(()=> handleClick("Education"))}>Where I learned</Button>
            </Box>
