  ...
  return (
    <Box sx={{padding: "10px", display: "flex", justifyContent: "center", alignItems: "center"}}>
      ...
      <Box  sx={{padding: "10px"}}>
        ...
        <Typography>
            I am a recent graduate of a six-month-long boot camp at Lighthouse Labs, where I obtained a diploma in Web Development. I also have a Bachelor's Degree in Mechanical Engineering from the British Columbia Institue of Technology.
        </Typography>
        <br></br>
        <Typography>
